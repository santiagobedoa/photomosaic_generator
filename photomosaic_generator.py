# ---libraries for: photomosaic generator
import os
import argparse
import cv2
import numpy as np
...
# the following code was made by "uvipen"
# you could find the documentation here:
# https://github.com/uvipen/Photomosaic-generator

# functions for photomosaic generator
def get_args():
    parser = argparse.ArgumentParser("Photomosaic Generator")
